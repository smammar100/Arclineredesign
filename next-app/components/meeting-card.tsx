    ...
    <div className="w-full bg-[#262626] border border-[#404040] rounded-[14px] p-[16px] overflow-hidden flex items-center gap-[16px]">
      ...
      <div className="flex-1 flex flex-col gap-[16px]">
        <div className="flex flex-col gap-[12px]">
          <h3 className="text-[20px] font-semibold text-[#e6e6e6] leading-[1.4] font-[family-name:var(--font-aeonik)]">
            Schedule a meeting
          </h3>
          <p className="text-[14px] text-[#606060] leading-[1.55] font-[family-name:var(--font-aeonik)]">
        ...
        <button className="inline-flex items-center gap-[8px] w-fit px-[13px] py-[10px] rounded-[8px] bg-[rgba(77,77,77,0.3)] border border-[#4d4d4d] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.5)]">
          ...
          <span className="text-[13px] font-medium text-[#fafafa] leading-[20px]">
            Schedule meeting
          </span>
        </button>
      </div>
