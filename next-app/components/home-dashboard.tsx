    ...
    >
      ...
      >
        <div className="flex flex-col gap-[8px]">
          <h1 className="text-[32px] font-medium text-white leading-[1.4] tracking-[-0.64px] font-[family-name:var(--font-aeonik)]">
            Welcome back, Muhammad
          </h1>
          <p className="text-[16px] text-[#bcbcc6] leading-[1.5] tracking-[-0.32px]">
      ...
      >
        ...
        >
          <h2
            className="flex-1 text-[20px] font-semibold leading-[1.4] bg-clip-text text-transparent font-[family-name:var(--font-aeonik)]"
            style={{
              backgroundImage:
